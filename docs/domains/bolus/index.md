...
Bolus data represents discrete insulin doses delivered by insulin pumps or injected manually. This domain covers bolus types, the bolus calculator (wizard), and related calculations.
...
| `insulin` | Manual injection | Pen/syringe (MDI) |
