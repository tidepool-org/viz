...
export class PumpSettingsContainer extends PureComponent {
  static propTypes = {
    ...
    manufacturerKey: PropTypes.oneOf(
      ['animas', 'carelink', 'insulet', 'medtronic', 'tandem', 'microtech', 'diy loop', 'tidepool loop', 'twiist loop']
    ).isRequired,
  ...
  render() {
    ...
    const supportedNonTandemPumps = ['animas', 'carelink', 'insulet', 'medtronic', 'microtech', 'diy loop', 'tidepool loop', 'twiist loop'];
