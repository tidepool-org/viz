...
export const FOCUS_TRENDS_SMBG_RANGE_AVG = 'FOCUS_TRENDS_SMBG_RANGE_AVG';
...
// Web Worker data filtering
export const WORKER_FILTER_DATA_REQUEST = 'WORKER_FILTER_DATA_REQUEST';
export const WORKER_FILTER_DATA_SUCCESS = 'WORKER_FILTER_DATA_SUCCESS';
export const WORKER_FILTER_DATA_FAILURE = 'WORKER_FILTER_DATA_FAILURE';

// Web Worker data preprocessing
export const WORKER_PROCESS_DATA_REQUEST = 'WORKER_PROCESS_DATA_REQUEST';
export const WORKER_PROCESS_DATA_SUCCESS = 'WORKER_PROCESS_DATA_SUCCESS';
export const WORKER_PROCESS_DATA_FAILURE = 'WORKER_PROCESS_DATA_FAILURE';
