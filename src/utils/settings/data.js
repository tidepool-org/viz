 ...
 * @param  {String} deviceKey    one of: animas, carelink, insulet, medtronic, tandem, microtech, tidepool loop, diy loop, twiist loop
 ...
 * @param  {String} manufacturer   one of: animas, carelink, insulet, medtronic, tandem, microtech, tidepool loop, diy loop, twiist loop
...
export function insulinSettings(settings, manufacturer, scheduleName) {
  ...
  if (_.includes(['diy loop', 'tidepool loop', 'twiist loop'], manufacturer)) {
 ...
 *
 * @param  {Object} settings       object with pump settings data
 * @param  {String} manufacturer   one of: tidepool loop, diy loop, twiist loop
 */
