...
stories.add('short annotation', () => (
  <div>
    {refDiv}
    <EventTooltip {...props} annotations={['A nice, concise annotation.']} />
  </div>
));
...
stories.add('long annotation', () => (
  <div>
    {refDiv}
    <EventTooltip {...props} annotations={['A longer annotation that should wrap due to a max-width of 190px set.']} />
  </div>
));
...
stories.add('markdown annotation', () => (
  <div>
    {refDiv}
    <EventTooltip {...props} annotations={['**A markdown annotation** that should [link](http://www.example.com) to example.com in a new tab']} />
  </div>
));
